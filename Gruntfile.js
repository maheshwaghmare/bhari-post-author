module.exports = function (grunt) {
    ...
    grunt.initConfig({
         ...
         */
        clean: {
            main: ["bhari-post-author"],
            zip: ["bhari-post-author.zip"]
        ...
        makepot: {
            target: {
                options: {
                    domainPath: '/',
                    potFilename: 'languages/bhari-post-author.pot',
                    potHeaders: {
                        poedit: true,
